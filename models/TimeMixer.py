...
class Model(nn.Module):
    ...
    def __init__(self, args):
        ...
        self.seq_len = configs.seq_len
        self.label_len = int(configs.seq_len//2)
        self.pred_len = configs.pred_len
        self.down_sampling_window = configs.down_sampling_window
        self.channel_independence = configs.channel_independence
        ...
        if self.channel_independence == 1:
            self.enc_embedding = DataEmbedding_wo_pos(1, configs.d_model, configs.embed, self.freq,
                                                      configs.dropout)
        else:
            self.enc_embedding = DataEmbedding_wo_pos(configs.enc_in, configs.d_model, configs.embed, self.freq,
                                                      configs.dropout)
    ...
    def get_setting(self, args):
        setting = 'TimeMixer_{}_{}_data{}_lr{}_loss{}_sl{}_pl{}'.format(
            args.data.data_path,
            args.data.freq,
            args.train.lr,
