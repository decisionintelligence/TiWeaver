...
class TimesBlock(nn.Module):
    def __init__(self, args):
        ...
        self.k = args.model.top_k
        # parameter-efficient design
        self.conv = nn.Sequential(
            Inception_Block_V1(
                args.model.d_model, args.model.d_ff, num_kernels=args.model.num_kernels
            ),
            nn.GELU(),
            Inception_Block_V1(
                args.model.d_ff, args.model.d_model, num_kernels=args.model.num_kernels
            ),
        )
...
class Model(nn.Module):
    ...
    def __init__(self, args):
        ...
        self.model = nn.ModuleList(
            [TimesBlock(args) for _ in range(args.model.e_layers)]
        )
        ...
        self.layer = args.model.e_layers
        self.layer_norm = nn.LayerNorm(args.model.d_model)
        # if (
        #     self.task_name == "long_term_forecast"
        #     or self.task_name == "short_term_forecast"
        # ):
        self.predict_linear = nn.Linear(self.seq_len, self.pred_len + self.seq_len)
        self.projection = nn.Linear(args.model.d_model, args.model.c_out, bias=True)
    ...
    def get_setting(self, args):
        setting = 'TimesNet_{}_{}_data{}_lr{}_loss{}_sl{}_pl{}_{}'.format(
            args.data.data_path,
            args.data.freq,
            args.train.lr,
