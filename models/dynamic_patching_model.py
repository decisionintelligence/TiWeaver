...
class Model(nn.Module):
    ...
    def get_setting(self, args):
        setting = 'Dynamic_{}_{}_lr{}_df{}_dm{}_{}_sl{}_pl{}'.format(
            args.data.data_path,
            args.data.freq,
            args.train.lr,
            args.model.d_ff,
    ...
    def forward(self, x, x_mark=None):
        ...
        for b in range(B):
            ...
            # decoder
            dec_out = self.decoder(dynamic_patch_embs) # [bs x n_vars x hidden_dim]
            dec_outs.append(dec_out)
            
        # 合并所有变量的输出
        dec_out = torch.stack(dec_outs, dim=0).squeeze(1)  # [bs x n_vars x hidden_dim]
