...
from models.layers.basics_lightgts import *
from models.layers.attention_lightgts import *
from models.layers.decoder_cnn import Decoder
...
class LightGTS(nn.Module):
    ...
    def __init__(self, c_in:int, target_dim:int, patch_len:int, stride:int, num_patch:int, mask_mode:str = 'patch',mask_nums:int = 3,
        ...
        self.target_dim=target_dim      #720，历史窗口大小
