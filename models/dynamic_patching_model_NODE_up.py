...
class Model(nn.Module, EncoderAttrs):
    def __init__(self, args):
        ...
        # ODE solver
        self.use_ode = args.model.odefunc.use
        ...
        if self.task_name == 'regular':
            ...
            self.decoder = nn.Sequential(
                    nn.Linear(self.d_model + self.time_dim, self.d_model),
    ...
    def get_setting(self, args):
        setting = 'Dynamic_NODE{}_{}_{}_lr{}_df{}_dm{}_{}_sl{}_pl{}_t{}_recon{}_fft{}_layer{}_patch{}_revin{}'.format(
