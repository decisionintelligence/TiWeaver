...
from Data_Provider.dependencies.tsdm.utils.types.dtypes import BOOLS, EMOJIS, STRINGS
from Data_Provider.dependencies.tsdm.utils.types.time import DTVar, TDVar
