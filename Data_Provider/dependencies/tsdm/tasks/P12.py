...
from Data_Provider.dependencies.tsdm.datasets import Physionet2012 as Physionet2012_Dataset
from Data_Provider.dependencies.tsdm.encoders import FrameEncoder, MinMaxScaler, Standardizer
from Data_Provider.dependencies.tsdm.tasks.base import BaseTask
from Data_Provider.dependencies.tsdm.utils import is_partition
...
class Physionet2012(BaseTask):
    ...
    # num_folds = 5
    RANDOM_STATE = 0
    test_size = 0.2  # of total
    valid_size = 0.25  # of train split size, i.e. 0.85*0.2=0.17
